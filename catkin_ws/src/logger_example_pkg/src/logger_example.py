...
while not rospy.is_shutdown():
    rospy.logfatal("There is a missing droid")
    rospy.logerr("The Emperors Capuchino is done")
    ...
    rospy.loginfo(" The thermal exhaust port %s, right below the main port %s", exhaust_number, port_number)
    rospy.logdebug("The DeathStar Is EXPLODING")
    rate.sleep()
    rospy.logfatal("END")