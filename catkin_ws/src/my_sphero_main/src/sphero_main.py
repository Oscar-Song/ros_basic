...
from my_sphero_topics import CmdVelPublisher
...
class ControlSphero(object):
    def __init__(self, goal_distance):
        ...
        self.odom_analysis = OdomAnalysis()
    ...
    def init_rec_odom_action_client(self):
        self._rec_odom_action_client = actionlib.SimpleActionClient('/calc_odom', record_odomAction)
    ...
    def init_move_sphero_publisher(self):
        self._cmdvelpub_object = CmdVelPublisher()

    def move_sphero(self, direction):
        self._cmdvelpub_object.move(direction)

    def got_out_maze(self, odom_result_array):
        return odom_analysis.check_dist_reached(self._goal_distance, odom_result_array)
