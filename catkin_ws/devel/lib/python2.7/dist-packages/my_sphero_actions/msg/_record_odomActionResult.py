...
"""autogenerated by genpy from my_sphero_actions/record_odomActionResult.msg. Do not edit."""
import sys
...
class record_odomActionResult(genpy.Message):
  ...
  _type = "my_sphero_actions/record_odomActionResult"
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','my_sphero_actions/record_odomResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = my_sphero_actions.msg.record_odomResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = my_sphero_actions.msg.record_odomResult()
