...
"""autogenerated by genpy from my_turtlebot_actions/record_odomActionFeedback.msg. Do not edit."""
import sys
...
class record_odomActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "my_turtlebot_actions/record_odomActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','my_turtlebot_actions/record_odomFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(record_odomActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = my_turtlebot_actions.msg.record_odomFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = my_turtlebot_actions.msg.record_odomFeedback()
