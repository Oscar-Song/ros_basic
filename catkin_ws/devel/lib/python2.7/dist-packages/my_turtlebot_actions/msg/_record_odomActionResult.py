...
"""autogenerated by genpy from my_turtlebot_actions/record_odomActionResult.msg. Do not edit."""
import sys
...
class record_odomActionResult(genpy.Message):
  _md5sum = "791d2d04aa1eab7db5b98c26043c1048"
  _type = "my_turtlebot_actions/record_odomActionResult"
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','my_turtlebot_actions/record_odomResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(record_odomActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = my_turtlebot_actions.msg.record_odomResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = my_turtlebot_actions.msg.record_odomResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.result.result_odom_array)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.result_odom_array:
        _v1 = val1.header
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.result.result_odom_array.append(val1)
      return self
