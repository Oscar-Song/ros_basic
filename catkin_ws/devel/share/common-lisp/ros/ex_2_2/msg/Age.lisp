...
(cl:defmethod cl:initialize-instance :after ((m <Age>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Age)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ex_2_2-msg:<Age> is deprecated: use ex_2_2-msg:Age instead.")))

(cl:ensure-generic-function 'years-val :lambda-list '(m))
(cl:defmethod years-val ((m <Age>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ex_2_2-msg:years-val is deprecated.  Use ex_2_2-msg:years instead.")
  (years m))

(cl:ensure-generic-function 'months-val :lambda-list '(m))
(cl:defmethod months-val ((m <Age>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ex_2_2-msg:months-val is deprecated.  Use ex_2_2-msg:months instead.")
  (months m))

(cl:ensure-generic-function 'days-val :lambda-list '(m))
(cl:defmethod days-val ((m <Age>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ex_2_2-msg:days-val is deprecated.  Use ex_2_2-msg:days instead.")
  (days m))
